...
TIPS = [
    ...
    {"text": "Backup task zips one unfinished task; Import task on a project page carries on with it there.",
     "ask": "How do I move an unfinished task to another project or computer?", "guide": "Backup and restore"},
    {"text": "Each account can keep its projects in its own folder: Settings, Projects folder.",
     "ask": "How do I change where my projects are saved?", "guide": "Settings"},

...
description: >
  ...
  accent, the three-step gray text ladder, Inter (display 700/900, body 400) + JetBrains Mono (commands),
...
colors:
  ...
  text-muted: "#5B6874"
  text-light: "#9A9A9A"
  accent-light: "rgba(10, 124, 120, 0.08)"
  accent-medium: "rgba(10, 124, 120, 0.15)"
  border: "rgba(10, 124, 120, 0.2)"
  card-bg: "rgba(10, 124, 120, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
